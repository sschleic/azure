...
class inverseCalculation(NumpyBasedTraceStep):
    """
    ...
    def GetDescription(cls):
        ...
        return textwrap.dedent('''
            This is an array-based NumPy trace step.
            ''').strip()
    ...
    def GetParameters(cls):
        ...
        """
        return [
            ParameterDefinition('Array1', 'IN', description=''),
            ParameterDefinition('Array2', 'IN', description=''),
            ParameterDefinition('invResult', 'OUT', description=''),
            ]
    ...
    def Process(self, parameters, report, timeAxis, ranges, signals):
        ...
        #    pass
        array1 = numpy.array(parameters["Array1"])
        array2 = numpy.array(parameters["Array2"])
        parameters["invResult"] = numpy.linalg.inv(array1)
        pass