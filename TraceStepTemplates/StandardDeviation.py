...
class StandardDeviation(NumpyBasedTraceStep):
    """
    ...
    def GetDescription(cls):
        ...
        return textwrap.dedent('''
            Calculates the standard deviation of a signal from a ground truth.
            ''').strip()
    ...
    def GetSignals(cls):
        ...
        """
        return [
            SignalDefinition('Signal', 'IN', optional=False, description='Signal the standard deviation should be calculated for.')
            ]
    ...
    def GetParameters(cls):
        ...
        """
        return [
            ParameterDefinition('StandardDeviation', 'OUT', description=""),
            ]
    ...
    def Process(self, parameters, report, timeAxis, ranges, signals):
        ...
        signalValues = signals['Signal'].GetValues()

        # calculate standard deviation
        standardDeviation = statistics.stdev(signalValues)

        # write calculated standard deviation of signal to return variable
